...
class TopicPolicyTest extends TestCase
{
    ...
    public function test_ssv_user_no_manager_cannot_create_topic(){
    ...
    public function test_pt_admin_can_update_topic(){
        ...
        $policy = new TopicPolicy();
        return $this->assertTrue($policy->update($PT_User, $BT_Topic, $BT_Course));
    }
}
